...
class Flatter {
    ...
    static attach(aFilename : string) {
    ...
    static dbTypeConversions = {
        'OBJECT': {
            toPlaceholder: (_e : string)    => { return `json(?)` },
            toDBValue    : (e : any, _key : string) => { 
            ...
            toJSValue    : (e : Object, k : string, cache : any) => {                 
                const reviver = (_key : string, v : any) => {
                    if ( v instanceof Object ) {                        
                        if (v.Flatter) {       
                            return classList[ v.class ].load( v.uuid, cache );
                        }
                    }
                    return v;    
                };
